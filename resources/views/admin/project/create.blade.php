        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a href="{{ route('admin.project.index') }}" class="btn btn-dark"><i
                                ...
                                <div class="card-body row">
                                    <div class="form-group col-12">
                                        ...
                                        <input id="title" type="text"
                                            ...
                                            value="{{ $project->title ?? old('title') }}" autofocus>
                                        @error('title')
                                    ...
                                    <div class="row col-12">
                                        ...
                                        <div class="form-group col-12 col-md-6">
                                            ...
                                            <input type="file" class="form-control dropify @error('photo') is-invalid @enderror" data-default-file="{{isset($project->photo) ? asset($project->photo) : ''}}"  name="photo" data-height="235" />
                                            @error('photo')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
