    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="{{route('admin.website.page.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
            </div>
                    ...
                    <tbody>
                      @foreach ($pages as $page)
                          <tr>
                            ...
                            <td>
                                <a href="{{route('admin.website.page.edit',$page->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                <a id="delete" href="{{route('admin.website.page.delete',$page->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-alt"></i></a>
                            </td>
                          </tr>
                      @endforeach
                    </tbody>
