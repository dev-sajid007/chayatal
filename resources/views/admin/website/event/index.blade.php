    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="{{route('admin.website.event.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
            </div>
                    ...
                    <tbody>
                       @foreach ($events as $event)
                           <tr>
                            ...
                            <td>
                                <input type="checkbox" data-size="sm" name="toggle" value="{{$event->id}}" data-toggle="switchbutton" {{$event->status == '1' ? 'checked':''}} data-onlabel="Active" data-offlabel="Inactive" data-onstyle="success" data-offstyle="danger">
                            </td>
                            <td>
                                <a href="{{route('admin.website.event.edit',$event->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                <a id="delete" href="{{route('admin.website.event.delete',$event->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-alt"></i></a>
                            </td>
                           </tr>
                       @endforeach
                    </tbody>
