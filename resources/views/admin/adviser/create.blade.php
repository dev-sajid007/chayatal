        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Adviser</h6>
                    <a href="{{ route('admin.adviser.index') }}" class="btn btn-dark"><i
                                ...
                                <div class="card-body row">
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input id="name" type="text"
                                            ...
                                            value="{{ $adviser->name ?? old('name') }}" autofocus>
                                        @error('name')
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input id="designation" type="text"
                                            ...
                                            value="{{ $adviser->designation ?? old('designation') }}" autofocus>
                                        @error('designation')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
