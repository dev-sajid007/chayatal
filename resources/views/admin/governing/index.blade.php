    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Governing Body List</h6>
                <a href="{{route('admin.governing_body.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
            </div>
                        ...
                        @foreach ($governings as $governing)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a id="delete" href="{{route('admin.governing_body.delete',$governing->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
