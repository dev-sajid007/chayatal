    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Story List</h6>
                <a href="{{route('admin.story.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
            </div>
                ...
                <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr class="align-middle">
                         ...
                         <td>
                             <img src="{{asset($story->photo)}}" class="img-thumbnail" style="width: 120px" alt="">
                         </td>
                         <td>{{$story->title}}</td>
                         ...
                         <td>
                             <a href="{{route('admin.story.edit',$story->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                             <a id="delete" href="{{route('admin.story.delete',$story->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-alt"></i></a>
                         </td>
                        </tr>
                    @endforeach
                    </tbody>
