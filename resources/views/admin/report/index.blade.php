...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h3 class="mb-0 text-gray-800">Chayatal Report</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">Home</a></li>
            <li class="breadcrumb-item">Chayatal Report</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Chayatal Report List</h6>
                    <a href="{{ route('admin.report.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add
                        New</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($reports as $report)
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <img src="{{ asset($report->photo) }}" class="img-thumbnail" style="width: 120px"
                                            alt="">
                                    </td>
                                    <td>{{ $report->title }}</td>
                                    <td>
                                        <a href="#" class="btn btn-success"><i class="fas fa-file-pdf"></i>
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a id="delete" href="{{ route('admin.report.delete', $report->id) }}"
